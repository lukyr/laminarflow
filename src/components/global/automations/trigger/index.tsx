...
import { ArrowBigRightIcon, SeparatorHorizontalIcon } from 'lucide-react';
        ...
        {data?.data?.trigger.length > 1 && (
          <>
            <div className="relative my-4 w-6/12">
              <p className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform bg-background-99 px-2">
                or
              </p>
            </div>
